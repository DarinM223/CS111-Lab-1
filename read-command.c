...
int dealWithOperator(stackOp *op_stack, stackCom *com_stack, int op_type); /* implemented */
int createCommandTree(stackOp* op_stack, stackCom* com_stack, int com_type); /* implemented */
                     ...
                     void *get_next_byte_argument)
{
    ...
    int str_size;
    char *str;
    str = (char*)checked_malloc(str_size*sizeof(char)); /* str_size is uninitialized */
